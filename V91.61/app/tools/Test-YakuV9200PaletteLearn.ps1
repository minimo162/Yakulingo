...
Chk ($paletteJs -match "function setTermLearnStatusLine") 'palette.js が学習の詳細文言を専用の関数経由で帯へ出す'
Chk ($paletteJs -match "setTermLearnStatusLine[\s\S]{0,40}?el\('palette-copy-status'\)") '学習の詳細文言は#palette-copy-status(帯の共有行)へ出す(MINOR-B)'
...
Write-Host '  -- シナリオ4/4.5/4.6/4.7/5: 文っぽい判定・確認の可否・重複/衝突表示 --'
