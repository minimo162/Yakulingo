...
Check-YakuDual ($candidateRoute -match '(?i)source_name' -and $candidateRoute -match '(?i)location' -and $candidateRoute -match '(?i)page' -and $candidateRoute -match '(?i)matched_terms' -and $candidateRoute -match '(?i)source_match_ratio' -and $candidateRoute -match '(?i)source' -and $candidateRoute -match '(?i)translation') 'candidate API returns normalized material, location, page, source, translation, and match basis'
...
Check-YakuDual ($catClient -match '(?i)item\.source_name' -and $catClient -match '(?i)item\.location' -and $catClient -match '(?i)item\.page' -and $catClient -match '(?i)item\.matched_terms' -and $catClient -match '(?i)item\.source_match_ratio' -and $catClient -match 'item\.source' -and $catClient -match 'item\.translation') 'CAT candidate UI displays normalized material, location, page, source, translation, and match basis'
...
Check-YakuDual ($catProjectSource -match 'Find-YakuTranslationMemory' -and $catProjectSource -match 'Find-YakuCorpusPairsForSegment') 'CAT exposes only self-confirmed translations and past examples as cross-project candidates'
