...
# 貼り付けた文章も資料と同じ経路になったので、用語集も過去訳も効く。
# 「使いません」と書くほうが嘘になった。押す前に、移る先と保存されることを書く。
Check-YakuQuick ($quickPage -notmatch '登録した訳語も使いません') '効かないという古い断りを残さない'
Check-YakuQuick ($quickPage -match '1行ずつ確認する画面に移ります' -and $quickPage -match '保存される') '移る先と保存されることを押す前に書く'
