...
Assert-YakuTrue -Condition ($fileTemplate.Contains('子会社 固定販促費 / 子会社固定販促費 -> Subs. Fixed Promo.') -and $fileTemplate.Contains('販売奨励金/固定販促費 -> VM / Fixed Promo.') -and $fileTemplate.Contains('国内その他 -> Dom. Oth.') -and $fileTemplate.Contains('連結調整他 -> Cons. Adj.')) -Message 'V91.58 shortened file exact-match labels missing'
...
Assert-YakuTrue -Condition ($v9157MainGlossary.Contains('固定販促費,Fixed Promo.') -and $v9157MainGlossary.Contains('子会社 固定販促費,Subs. Fixed Promo.') -and $v9157MainGlossary.Contains('子会社固定販促費,Subs. Fixed Promo.') -and $v9157MainGlossary.Contains('販売奨励金/固定販促費,VM / Fixed Promo.') -and $v9157MainGlossary.Contains('国内その他,Dom. Oth.') -and $v9157MainGlossary.Contains('連結調整他,Cons. Adj.')) -Message 'V91.58 exact-match shortened mappings missing'
